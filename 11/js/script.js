  ...
  prepareSmilAnimation() {
    if (this.screenElements[this.activeScreen].id === 'prizes') {
      ...
      prizes.forEach((prize) => {
        const prizeSmilAnimation = _smil_animation__WEBPACK_IMPORTED_MODULE_1__["default"].create({
          rootNode: prize,
